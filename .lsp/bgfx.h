...
EMPTY_STRUCT(sampler2DShadow)
EMPTY_STRUCT(sampler2DArray)
EMPTY_STRUCT(sampler2DArrayShadow)

vec4 texture2D(sampler2D, vec2);
float shadow2D(sampler2DShadow, vec3);
float shadow2DArray(sampler2DArrayShadow, vec4);
...
#define SAMPLER2DARRAYSHADOW(_sampler, _reg) uniform sampler2DArrayShadow _sampler;
#define SAMPLER2DSHADOW(_sampler, _reg) uniform sampler2DShadow _sampler;
#define SAMPLER2D(_sampler, _reg) uniform sampler2D _sampler;
#define BUFFER_RO(_name, _type, _reg) uniform _type *_name;
